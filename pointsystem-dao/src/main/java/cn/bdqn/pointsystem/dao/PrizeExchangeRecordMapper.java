...
public interface PrizeExchangeRecordMapper extends BaseMapper<PrizeExchangeRecord> {
     ...
     * @return
     */
    public IPage<PrizeExchangeRecord> selectPrizeExchangeRecordPage(Page<PrizeExchangeRecord> page,@Param("name") String name,@Param("gradeId") Integer gradeId);
     ...
     * @return
     */
    public int getPrizeCount(@Param("name") String name,@Param("gradeId") Integer gradeId);
