...
public class PrizeExchangeRecordServiceImpl implements PrizeExchangeRecordService {
    ...
    public synchronized boolean exchangePrizes(Integer userId, Integer prizeId, Integer point, Integer userPoint) throws Exception {
        Integer result = 0;
        //1.添加一条兑换记录
        ...
        //3.修改学生积分
        result = userMapper.updateUserPoint(userPoint-point, userId);
     ...
     */
    @Override
    public IPage<PrizeExchangeRecord> selectPrizeExchangeRecordPage(Page<PrizeExchangeRecord> page, String name,Integer gradeId) {
     ...
     */
    @Override
    public int getPrizeCount(String name,Integer gradeId) {
        return exchangeRecordMapper.getPrizeCount(name,gradeId);
    }
